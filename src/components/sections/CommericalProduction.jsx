...
export default function CommericalProduction() {
  return (
    <section className="min-h-screen py-20 px-6 bg-linear-to-b from-indigo-50 via-white to-indigo-50">
      <div className="max-w-7xl mx-auto text-center">
        ...
        >
          Commercialization of Technical Textile products is capital intensive
          and hence to help the industry to develop and commercialize the
          product to understand the market, COE Indutech has invested in full
          production lines for some technical textile products. List of all the
          current full production set up is given below:
        </motion.p>
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  <div
                    className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 text-white shadow-lg bg-linear-to-br ${item.color}`}
                  >
