...
const ITEMS = [
  {
    ...
    color: "#9C0060",
    light: "#E91E8C",
    desc: "Centralized hub for research, data & industry knowledge.",
  },
  {
    id: 1,
    short: "Pilot\nFacility",
    label: "Pilot Facility",
    color: "#5C1191",
    light: "#AB47BC",
    desc: "State-of-the-art infrastructure to prototype & validate innovations.",
  },
  {
    id: 2,
    short: "Incubation\nCenter",
    ...
    color: "#006A77",
    light: "#00BCD4",
    desc: "Nurturing early-stage ventures with mentorship & resources.",
  },
  {
    id: 3,
    short: "BIS Test\nStandards",
    label: "Support BIS Standards",
    color: "#1B5E20",
    light: "#43A047",
    desc: "Collaborating with BIS to shape next-gen quality benchmarks.",
  },
  {
    id: 4,
    short: "Training &\nWorkshops",
    ...
    color: "#B74800",
    light: "#FF7043",
    desc: "Expert-led programs designed to upskill industry professionals.",
  },
  {
    id: 5,
    short: "Testing\nCapabilities",
    ...
    color: "#880E1F",
    light: "#EF5350",
    desc: "Advanced testing infrastructure for robust product validation.",
  },
  {
    id: 6,
    short: "Consultancy",
    ...
    color: "#C45E00",
    light: "#F47920",
    desc: "Strategic advisory driving operational excellence & growth.",
  },
];
  ...
  return (
    ...
    >
      ...
      <motion.div
        animate={{
          filter: active
            ? `brightness(1.18) drop-shadow(0 0 14px ${item.light}28)`
            : "brightness(0.96)",
        }}
        transition={{ duration: 0.3 }}
        style={{
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          clipPath: HEX_CLIP,
          background: "rgba(26,126,200,0.24)",
        }}
      />
      {/* Inner */}
      <div
        ...
        <AnimatePresence mode="wait">
          {activeItem ? (
            ...
            >
              <div
                style={{
                  fontSize: Math.max(10, hubW * 0.11),
              ...
              <p
                style={{
                  margin: 0,
                  fontSize: Math.max(5, hubW * 0.067),
                  fontWeight: 700,
                  color: activeItem.light,
                  textAlign: "center",
                  lineHeight: 1.3,
            ...
            >
              <motion.div
                ...
                style={{
                  width: "26%",
                  aspectRatio: "1",
                  border: "1.5px solid rgba(26,126,200,0.5)",
                  clipPath: HEX_CLIP,
                }}
              />
              <p
                style={{
                  margin: 0,
                  fontSize: Math.max(6, hubW * 0.074),
                  fontWeight: 800,
                  color: S.blue,
              ...
              <p
                style={{
                  margin: 0,
                  fontSize: Math.max(4, hubW * 0.046),
        ...
        >
          <motion.div
            ...
            style={{
              ...
              height: 8,
              borderRadius: "50%",
              background: activeItem.light,
              flexShrink: 0,
              boxShadow: `0 0 10px ${activeItem.light}`,
            }}
          />
          <span
            style={{ color: activeItem.light, fontSize: 18, flexShrink: 0 }}
          >
            {ICONS[activeItem.id]}
          </span>
          <p
          ...
          >
            <strong style={{ color: activeItem.light, fontWeight: 700 }}>
              {activeItem.label}:
            </strong>{" "}
            <span style={{ color: S.muted }}>{activeItem.desc}</span>
          </p>
  ...
  >
    ...
    >
      ...
      <motion.div
        animate={{
          filter: active
            ? `brightness(1.2) drop-shadow(0 0 10px ${item.light}88)`
            : "brightness(0.95)",
        }}
        style={{
          position: "absolute",
        ...
        >
          <div
            style={{
              ...
              inset: 0,
              background:
                "radial-gradient(ellipse 600px 400px at 50% 50%,rgba(26,126,200,0.07),transparent 70%)",
            }}
          />
        </motion.div>
          ...
          >
            ...
            >
              <motion.div
                ...
                style={{
                  width: 28,
                  height: 1.5,
                  background: `linear-gradient(90deg,transparent,${S.blue})`,
                  borderRadius: 99,
                }}
              />
              <span
              ...
              <motion.div
                ...
                style={{
                  width: 28,
                  height: 1.5,
                  background: `linear-gradient(90deg,${S.blue},transparent)`,
                  borderRadius: 99,
                }}
              />
            </div>
            ...
            <motion.div
              ...
              style={{
                ...
                width: 56,
                height: 2,
                background: `linear-gradient(90deg,${S.blue},rgba(26,126,200,0.2))`,
                borderRadius: 99,
            ...
            <AnimatePresence mode="wait">
              {activeItem && (
                ...
                >
                  ...
                  >
                    <span style={{ color: activeItem.light, fontSize: 20 }}>
                      {ICONS[activeItem.id]}
                    </span>
                    <motion.div
                      animate={{ scale: [1, 1.5, 1], opacity: [0.5, 1, 0.5] }}
