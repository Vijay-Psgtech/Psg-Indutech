              ...
              {facilitiesOpen && (
                ...
                >
                  ...
                  <div
                    ...
                    className="relative"
                  >
                    <button className="flex justify-between w-full px-4 py-2 text-sm hover:bg-indigo-50">
                      Commercial Production
                      <ChevronDown className="w-4 h-4" />
                    </button>

                    {commercialOpen && (
                      <div className="absolute left-full top-0 bg-white shadow-lg rounded-lg w-72">
                        {[
                          {
          ...
          >
            ...
            <div className="w-full">
              <button
                ...
                className="flex justify-between w-full px-3 py-2 font-medium text-sm"
              >
                Facilities
                <ChevronDown
                  className={`w-4 h-4 ${facilitiesOpen ? "rotate-180" : ""}`}
                />
              </button>

              {facilitiesOpen && (
                <div className="ml-4">
                  <p className="font-semibold mt-2">Commercial Production</p>
