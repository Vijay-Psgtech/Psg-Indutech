...
const Header = () => {
  ...
  return (
    <header
      role="banner"
      className="fixed top-0 left-0 w-full z-100 flex justify-center align-middle shadow-md"
      style={{
        backgroundColor: "rgba(255,255,255,0.98)",
        backdropFilter: "blur(10px)",
      }}
    >
      <nav className="w-full px-2 sm:px-8 lg:px-22 py-4 md:py-3 flex items-center justify-between">
        {/* Logo */}
        ...
        {/* Desktop menu */}
        <div className="hidden md:flex items-stretch space-x-2 lg:space-x-4 ">
          <a
            href="/"
            className="px-3 py-2 text-sm font-semibold text-gray-700 hover:text-indigo-600 hover:bg-indigo-50 rounded-md transition duration-200"
          >
            Home
          </a>
