...
export default function EventsSection() {
  ...
  return (
  <section className="w-full px-6 py-20" style={{ backgroundImage: 'linear-gradient(to bottom, rgba(255,255,255,1), var(--color-indigo-50))' }}>
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
          <h2 className="text-3xl md:text-4xl font-bold border-b-4 border-transparent inline-block transition-all" style={{ color: 'var(--color-deep-indigo)', borderColor: 'var(--color-indigo)' }}>
            Events & Summaries
          </h2>
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
                ...
                <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-600 whitespace-nowrap">
                  <Calendar className="w-4 sm:w-5 h-4 sm:h-5" style={{ color: 'var(--color-indigo)' }} />
              ...
              <div className="mt-6 flex items-center justify-between gap-4">
                <span className="text-xs px-3 py-1 rounded-full border" style={{ backgroundColor: 'var(--color-indigo-50)', color: 'var(--color-indigo)', borderColor: 'var(--color-indigo-100)' }}>
                  {ev.category}
                </span>
                <button
