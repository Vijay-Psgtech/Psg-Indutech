...
import { Flame, ArrowRight, Sparkles, User, Mail } from "lucide-react";
import {
  sections,
  specifications,
  applications,
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-8">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-cyan-100 font-medium">
                Heat/Melt Bonding | Wadding Machine
              </p>

              <p className="text-sm text-gray-200 mt-2 max-w-xl">
                Thermal bonding, also known as heat bonding or melt bonding, is
                a process in which a fibre web is fused at the fibre crossover
                points.
              </p>
                ...
                >
                  ...
                  <div className="space-y-6 text-slate-700 leading-relaxed text-base sm:text-lg">
                    <p>
                      ...
                      points. This is achieved by passing the web through a
                      controlled heat source—typically hot air—causing the
                      thermoplastic fibres to soften and bond at their points of
                      intersection.
                    </p>

                    <p>
                      In practice, the process sequence is similar to that of
                      needle-punched fabric production. After the cross-lapper,
                      the cross-laid web is conveyed into a single-chamber oven
                      equipped with appropriate gas burners. The oven has a
                      chamber length of 3 meters, and the operating temperature
                      can be adjusted between 120 °C and 200 °C, depending on
                      the fibre composition and the required bonding strength.
                    </p>

                    <p>
                      This configuration ensures uniform bonding across the web,
                      while maintaining process safety, energy efficiency, and
