...
import { CheckCircle, Layers, Zap, Settings, Package, TrendingUp } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-600 mt-1">LACOM MPBL2400 CV – 2015 Model</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="bg-gradient-to-br from-[#22227A] to-[#6D77B3] rounded-2xl p-8 md:p-12 text-white shadow-xl">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-3xl font-bold mb-3">Advanced Bonding Technology</h2>
                  <p className="text-blue-100 text-lg leading-relaxed">
                    The process involves bonding two substrates using hot-melt adhesive, applied under controlled
                    temperature conditions with the help of a drum melter or extruder. COE INDUTECH is equipped
                    with a compact model coating and lamination machine supplied by Lacom, Germany, with a
                    working width of 2000 mm.
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                  ...
                  <div className="text-blue-100 text-sm mt-1">Working Width</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-white rounded-xl shadow-md p-6 border border-slate-200">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-slate-900">Equipment Features</h3>
                </div>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span className="text-slate-700">IR heater for precise temperature control</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span className="text-slate-700">Drum melters (20 kg and 200 kg capacities)</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span className="text-slate-700">Extruder for precise adhesive application</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span className="text-slate-700">Positive and negative blade system</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span className="text-slate-700">Multi-blade system for full-surface coating</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border border-slate-200">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-slate-900">Compatible Materials</h3>
                </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900">Key Advantages</h3>
              </div>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
              <h3 className="text-lg font-semibold text-amber-900 mb-3">Order Information</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white rounded-lg p-4">
                  <div className="text-sm text-slate-600 mb-1">Minimum Order Quantity</div>
                  <div className="text-2xl font-bold text-slate-900">2000 meters</div>
                </div>
                <div className="bg-white rounded-lg p-4">
                  <div className="text-sm text-slate-600 mb-1">Sample Quantity</div>
                  <div className="text-2xl font-bold text-slate-900">100 meters</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'specifications' && (
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border border-slate-200">
              <h3 className="text-xl font-semibold text-slate-900 mb-4">Raw Materials</h3>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {['PUR', 'TPU Film', 'PE Film'].map((material, index) => (
                  ...
                  >
                    <span className="text-lg font-semibold text-blue-900">{material}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl p-6 border border-slate-300">
              <h3 className="text-xl font-semibold text-slate-900 mb-3">Production Note</h3>
              <p className="text-slate-700 leading-relaxed">
                Production capacity varies from 2000 to 15,000 meters per shift depending on the
                fabric type being processed.
              </p>
            </div>
          </div>
        )}
        ...
        {activeTab === 'applications' && (
          <div className="space-y-6 animate-fade-in">
            <div className="bg-white rounded-xl shadow-md p-6 border border-slate-200">
              <h2 className="text-2xl font-bold text-slate-900 mb-6">Key Applications</h2>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border border-slate-200">
              <h2 className="text-2xl font-bold text-slate-900 mb-6">Product Applications</h2>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-200">
              ...
              <p className="text-slate-700 leading-relaxed">
                ...
                applications, providing versatility for various market segments.
              </p>
            </div>
          </div>
        )}
