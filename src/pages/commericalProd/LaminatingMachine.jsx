  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 space-y-10">
        <div className="relative min-h-screen mt-4 transition-all duration-300">
        {/* Overview Tab */}
          {activeTab === "overview" && (
                  ...
                  <div className="flex-1 space-y-6">
                    <div>
                      ...
                      <p className="text-lg text-blue-100 leading-relaxed">
                        State-of-the-art bonding system using hot-melt adhesive
                        under controlled temperature conditions with drum melter
                        or extruder technology. COE INDUTECH utilizes a compact
                        Lacom coating and lamination machine with exceptional
                        precision.
                      </p>
                    </div>
            ...
            >
                ...
                <div className="divide-y divide-slate-200">
                  {specifications.map((spec, index) => (
                    ...
                    >
                      ...
                      <span
                        className="text-lg font-black px-5 py-2.5 rounded-xl"
                        style={{
              ...
              >
                ...
                <p className="text-lg text-slate-700 leading-relaxed">
                  ...
                  depending on the fabric type being processed. This flexibility
                  allows for optimized production across various material
                  specifications.
                </p>
              </motion.div>
            </motion.div>
              ...
              >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                  {productApplications.map((product, idx) => (
                    ...
                    >
                      <span
                        className="font-semibold text-sm group-hover:text-base transition-all"
                        style={{ color: brandColors.primary }}
                      >
                        {product}
                      </span>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-slate-700 leading-relaxed">
                      Products manufactured using this machine cater to both
                      domestic and industrial applications, providing versatility
                      for various market segments. From home textiles to
                      industrial-grade materials, our laminating technology
                      delivers consistent quality across all applications.
                    </p>
                  </div>
                </div>
              </motion.div>
