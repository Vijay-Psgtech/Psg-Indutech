...
/* ─────────────────────────────────────────────────────────────
   BRAND PALETTE — light theme (from screenshot)
   BG:        #f4f6fb  (page background — near white/periwinkle)
   SURFACE:   #ffffff  (cards, panels)
   SURFACE2:  #eef1f9  (subtle tinted panels)
   NAVY:      #1a237e  (primary text / headings)
   NAVYMID:   #283593  (secondary headings)
   TEAL:      #00acc1  (primary accent — lines, highlights)
   TEALLT:    #e0f7fa  (teal tint bg)
   BODY:      #4a5568  (body text)
   MUTED:     #8a97b0  (secondary / labels)
   DIVIDER:   #e2e8f0
   SCROLLBG:  #1a237e  (dark navy — notification bar)
───────────────────────────────────────────────────────────── */
  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .email-row:hover { color: #00acc1; }
        .email-row svg { flex-shrink: 0; color: #00acc1; }
      ...
      >
        {/* Soft teal geometric shape — right */}
        <div
          style={{
            position: "absolute",
            top: 0,
            ...
            width: 480,
            height: "100%",
            background: `linear-gradient(150deg, rgba(0,172,193,0.08) 0%, rgba(0,172,193,0.03) 100%)`,
        ...
        >
          ...
          <div style={{ maxWidth: 540 }}>
            ...
            <motion.p
              ...
              style={{ fontSize: 14, lineHeight: 1.75, color: BODY, margin: "0 0 32px" }}
            >
          ...
          >
            <div
              style={{
                ...
                borderRadius: 16,
                overflow: "hidden",
                boxShadow: `0 0 0 4px ${TEALLT}, 0 24px 64px rgba(26,35,126,0.18)`,
              }}
            >
              <img
          ...
          >
            <div>
              ...
              <p style={{ fontSize: 13, color: BODY, maxWidth: 400, lineHeight: 1.65, margin: 0 }}>
                Specialized cells, each equipped with calibrated high-precision
      ...
      >
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 13, color: BODY, margin: "0 0 32px", lineHeight: 1.6, maxWidth: 420 }}>
            For test requests, instrument bookings, or technical enquiries, reach our lab
            coordinators directly via the addresses below.
          </p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
            ...
            >
              ...
              {["testing.int@psgtech.ac.in", "testing1.int@psgtech.ac.in"].map((email) => (
                <a key={email} href={`mailto:${email}`} className="email-row">
                  <Mail size={14} />
                  {email}
                </a>
              ))}
            ...
            >
              ...
              <a href="mailto:semedaxlab@psgtech.ac.in" className="email-row">
                <Mail size={14} />
