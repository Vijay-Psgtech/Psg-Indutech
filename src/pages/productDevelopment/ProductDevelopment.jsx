...
const getIconForTitle = (title) => {
  ...
  if (lowerTitle.includes("insulation"))
  ...
  if (lowerTitle.includes("speciality"))
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          >
            ...
            Hometech and we concentrate on the following technical textile
            products. The below list of products are selected as we have testing
            capabilities related to these products or we have expertise to work
            on these products.
          </motion.p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center bg-white rounded-3xl p-4 shadow-xl border border-indigo-50 overflow-hidden">
          ...
          >
            ...
            <p className="text-slate-600 mb-8 max-w-md mx-auto lg:mx-0">
              Contact our Product Development In-Charge for collaboration and
