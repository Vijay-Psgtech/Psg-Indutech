          ...
          <motion.div className="p-6 lg:p-10 text-center lg:text-left" initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="flex items-center justify-center lg:justify-start gap-3 p-4 rounded-xl bg-indigo-600 text-white hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200 group w-full"
              >
