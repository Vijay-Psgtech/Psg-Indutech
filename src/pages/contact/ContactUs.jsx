    ...
    <section className="min-h-screen flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-slate-50 to-indigo-50/50">
      ...
      >
        <div className="grid lg:grid-cols-5 h-full">
          ...
          <div className="lg:col-span-2 p-8 sm:p-10 bg-linear-to-br from-white to-slate-50 border-b lg:border-b-0 lg:border-r border-slate-100 flex flex-col justify-between">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">Mr. V. Muthukumar</p>
                    <a
