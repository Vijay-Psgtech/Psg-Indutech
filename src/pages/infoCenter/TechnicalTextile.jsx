...
import { technicalLinks } from "../../components/data/TechnicalTextileData";

const TechnicalTextile = () => {
  const [search, setSearch] = useState("");

  const filteredLinks = technicalLinks.filter((item) =>
    ...
    <section className="min-h-screen py-20 px-6 bg-gradient-to-b from-indigo-50 via-white to-indigo-50">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.h1
          ...
          style={{ color: "#22227A" }}
        >
          National & International sites with information on Technical Textiles
        </motion.h1>
...
export default TechnicalTextile;
