          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              >
                ...
                <div className="flex flex-wrap gap-4 mb-6">
                  {specifications.slice(0, 3).map((spec, i) => {
                    ...
                    return (
                      <div
                        key={i}
                        className="flex items-center gap-3 bg-white/90 p-3 rounded-lg"
                ...
                <button
                  className="group inline-flex items-center gap-2 px-6 py-3 rounded-full text-white font-bold"
                  style={{
                    background: grad.subtle,
                    boxShadow: `0 8px 32px ${brandColors.accent}30`,
                  }}
                >
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    boxShadow: isSelected
                      ? `0 20px 50px -10px ${brandColors.accent}30`
                ...
                >
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div
                        className="inline-flex items-center gap-2 px-3 py-1 rounded-md text-xs font-bold"
                        style={{
                          background: grad.card,
                ...
                <div key={i} className="relative">
                  ...
                  >
                    ...
                    <div className="relative flex-shrink-0">
                      ...
                      {!isLast && (
                        <div
                          className="absolute top-20 left-1/2 -translate-x-1/2 w-1 h-20 rounded-full"
                        ...
                        <div className="space-y-2">
                          ...
                          {process.layers.map((layer, idx) => (
                            <div key={idx} className="flex items-center gap-3">
                              <div
                                className="w-12 h-8 rounded-md border-2"
                                style={{
            ...
            <div className="space-y-4">
              {availableColors.map((color, i) => (
                ...
                >
                  {/* Color swatch */}
                  <div
                    className="w-16 h-16 rounded-xl border-2 shadow-md"
                    style={{
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {specifications.map((spec, i) => {
              ...
              return (
                ...
                >
                  <div
                    className="w-16 h-16 rounded-xl flex items-center justify-center mx-auto mb-3 shadow-md"
